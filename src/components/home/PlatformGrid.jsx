  ...
  return (
    <div className="service-selection">
      ...
      <div className="platform-grid">
        ...
        {categories.map(({ category_id, name, slug,image_url }) => {
          ...
          return (
            ...
            >
              <img src={`${image_url ? image_url : 'https://assets.snsshop.kr/assets/img2/new-order/platform/recommend.svg'}`} alt={name} className="platform-icon" />
