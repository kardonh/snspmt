...
const OrderPage = () => {
  ...
  const serviceIdMapping = {
    instagram: {
      followers_korean: 657,    // 인스타그램 팔로워 (한국인) - API ID: 657
