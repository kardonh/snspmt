...
const Home = () => {
  ...
  const instagramDetailedServices = {
    ...
    likes_korean: [
      { id: 124, name: '한국인 좋아요', price: 19500, min: 30, max: 10000, time: '2 시간 43 분' },
      { id: 275, name: '한국인 [남자] 좋아요', price: 25500, min: 30, max: 5000, time: '데이터가 충분하지 않습니다' },
      { id: 276, name: '한국인 [여자] 좋아요', price: 25500, min: 30, max: 5000, time: '5 분' },
      { id: 277, name: '한국인 [20대] 좋아요💖', price: 25500, min: 30, max: 5000, time: '데이터가 충분하지 않습니다' },
      { id: 278, name: '한국인 [30대] 좋아요💖', price: 25500, min: 30, max: 5000, time: '데이터가 충분하지 않습니다' }
     ],
    likes_foreign: [
      { id: 116, name: '440 [🥇추천]인스타그램 리얼 외국인 좋아요💖[저속][업데이트서버_08월_18일]', price: 1200, min: 100, max: 100000, time: '5 시간 7 분' }
    ],
    followers_korean: [
      { id: 125, name: '한국인 팔로워', price: 90000, min: 10, max: 40000, time: '13 시간 40 분' },
      { id: 283, name: '한국인 [남자] 팔로워', price: 117000, min: 10, max: 10000, time: '3 시간 17 분' },
      { id: 284, name: '한국인 [여자] 팔로워', price: 117000, min: 10, max: 10000, time: '3 시간 6 분' },
      { id: 285, name: '한국인 [20대] 팔로워', price: 117000, min: 10, max: 10000, time: '데이터가 충분하지 않습니다' },
      { id: 286, name: '한국인 [30대] 팔로워', price: 117000, min: 10, max: 10000, time: '데이터가 충분하지 않습니다' },
           ],
    views: [
      { id: 109, name: '동영상 조회수 릴스,게시물', price: 293, min: 100, max: 2147483647, time: '9 분' },
        ],
    comments_korean: [
